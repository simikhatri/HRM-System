                        ...
                        <Row className="textfield">
                            ...
                            <Accordion className="accordion mt-4" defaultActiveKey="0">
                                <Accordion.Item eventKey="0">
                                    <Accordion.Header >Monthly Leave - Add New</Accordion.Header>
                                ...
                                <Accordion.Item eventKey="1">
                                    <Accordion.Header >Monthly Leave - Details</Accordion.Header>
                                    <Accordion.Body className="accordion-body mb-4">
                                        <Form>
                                            <Row className="textfield">
                                                <Col lg={6} md={6} sm={6} xs={12}>
                                                ...
                                                <Col lg={6} md={6} sm={6} xs={12}>
                                                    <div className="mb-3 pt-2 me-2">
                                                        <Form.Label className="form-label">No of Days<span className="important">*</span> </Form.Label>
