            ...
            <Row className="textfield">
                <div className="Heading pb-2 ps-1">
                    <Row>
                        <Col lg={10} md={10} sm={10} xs={10}>
                            <h5>Loan Adjustment to be sent for Approval</h5>
                        </Col>
                ...
                <Accordion className="accordion mt-4" defaultActiveKey="0">
                    <Accordion.Item eventKey="0">
                        <Accordion.Header >Loan Adjustment to be sent for Approval - New</Accordion.Header>
                            ...
                            <Form>
                                <Row className="textfield">
                                    ...
                                    <Col lg={6} md={6} sm={6} xs={12}>
                                        ...
                                        <div className="mb-3 pt-2 me-2">
                                            <Form.Label className="form-label">Principle Amount</Form.Label>
                                            <p>.</p>
                                        </div>
                                        <div className="mb-3 pt-2 me-2">
                                            <Form.Label className="form-label">Markup Amount</Form.Label>
                                            <p>.</p>
                                        </div>
                                        <div className="mb-3 pt-2 me-2">
                                    ...
                                    <Col lg={6} md={6} sm={6} xs={12}>
                                        ...
                                        <div className="mb-3 pt-2 me-2">
                                            <Form.Label className="form-label">Balance Principle Amount</Form.Label>
                                            <p>.</p>
                                        </div>
                                        <div className="mb-3 pt-2 me-2">
                                            <Form.Label className="form-label">Balance Markup Amount</Form.Label>
                                            <p>.</p>
                                        </div>
                                        <div className="mb-3 pt-2 me-2">
