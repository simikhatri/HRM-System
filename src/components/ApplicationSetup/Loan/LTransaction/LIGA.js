                ...
                <Row className="textfield">
                    <div className="Heading pb-2 ps-1">
                        <Row>
                            <Col lg={10} md={10} sm={10} xs={10}>
                                <h5>Loan Installment Generation Approval</h5>
                            </Col>
                    ...
                    <Accordion className="accordion mt-4" defaultActiveKey="0">
                        <Accordion.Item eventKey="0">
                            <Accordion.Header >Loan Installment Generation Approval</Accordion.Header>
                        ...
                        <Accordion.Item eventKey="1">
                            <Accordion.Header >Loan Installment Generation - Manage</Accordion.Header>
                            <Accordion.Body className="accordion-body mb-4">
                                <Form>
                                    <Row className="textfield">
