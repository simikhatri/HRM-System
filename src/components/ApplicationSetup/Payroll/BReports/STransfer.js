                ...
                <Row className="textfield">
                    ...
                    <Col lg={6} md={6} sm={6} xs={12}>
                        ...
                        <div className="mb-4 pt-2 me-2">
                            <Form.Label className="form-label">Cheque Date<span className="important">*</span> </Form.Label>
                    ...
                    <div className="mb-3 pt-2 me-2">
                        ...
                        <div className="mb-4 pt-2 me-2">
                        <Form.Label className="form-label">Cheque No<span className="important">*</span> </Form.Label>
                        <Form.Control type="date" className="form-control" required />
                    </div>
                    </Col>
