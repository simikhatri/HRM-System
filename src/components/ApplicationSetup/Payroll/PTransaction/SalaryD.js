                    ...
                    <Form className="form SetupForm mt-4 ms-2">
                        <Row className="textfield">
                            ...
                            <Col lg={6} md={6} sm={6} xs={12}>
                                ...
                                <div className="mb-3 pt-2 me-2">
                                    <Form.Label className="form-label">Order By<span className="important">*</span> </Form.Label>
                                    <Form.Select className="form-select status" name="cat" aria-label="Default select example" required>
                                    <option value="0">--Please Select--</option>
                                            <option value="1">...</option>
                                            <option value="2">..</option>
                            ...
                            <div className="d-flex flex-row-reverse GenerateReport">
                                <button type="button" onClick={handleClick} className="btn">Get Employees</button>
                            </div>
                        </Row>
                    </Form>
                </div>
