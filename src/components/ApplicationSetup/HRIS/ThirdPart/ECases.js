                    ...
                    <Form className="form SetupForm mt-4 ms-2">
                        <Row className="textfield">
                            ...
                            <Col lg={6} md={6} sm={6} xs={12}>
                                ...
                                <div className="mb-3 pt-2 me-2">
                                    <Form.Label className="form-label">Case<span className="important">*</span> </Form.Label>
                                    <Form.Select className="form-select status" name="cat" aria-label="Default select example" required>
                            ...
                            <div className="mb-4 me-2 pt-2">
                                    <Form.Label className="form-label">Start On<span className="important">*</span> </Form.Label>
                                    <Form.Control type="date" className="form-control" required />
                                </div>
                                <div className="mb-4 me-2 ">
                                    <Form.Label className="form-label">Case Summary<span className="important">*</span> </Form.Label>
