                    ...
                    <Form className="form SetupForm mt-4 ms-2">
                        <Row className="textfield">
                            <div className="Heading pb-2 ps-1">
                                <Row>
                                    <Col lg={10} md={10} sm={10} xs={10}>
                                        <h5>One Time Payment - Add New</h5>
                                    </Col>
                            ...
                            <Col lg={6} md={6} sm={6} xs={12}>
                                ...
                                <div className="mb-4 me-2 pt-3">
                                    <Form.Label className="form-label">Amount<span className="important">*</span> </Form.Label>
                                    <Form.Control type="text" className="form-control" required />
                                </div>
                            </Col>
