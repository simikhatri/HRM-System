                        ...
                        <Row className="textfield">
                            ...
                            <Col lg={6} md={6} sm={6} xs={12}>
                                <div className="mb-3 pt-2 me-2">
                                    <Form.Label className="form-label">Certification Type<span className="important">*</span> </Form.Label>
                            ...
                            <Col lg={6} md={6} sm={6} xs={12}>
                                ...
                                <div className="mb-3 pt-2">
                                    <Form.Label  className="form-label">Validity Period(Month)<span className="important">*</span> </Form.Label>
                                    <Form.Control type="text" className="form-control" required />
                                </div>
                            </Col>
