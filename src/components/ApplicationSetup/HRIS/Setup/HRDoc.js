                        ...
                        <Row className="textfield">
                            ...
                            <Col lg={6} md={6} sm={6} xs={12}>
                                <div className="mb-3 pt-2 me-2">
                                    <Form.Label className="form-label">Document Code<span className="important">*</span> </Form.Label>
                                    <Form.Control type="text" className="form-control" required />
                                </div>
                                <div className="mb-4 me-2 pt-2">
                                    <Form.Label className="form-label">Document Type<span className="important">*</span> </Form.Label>
                                ...
                                <div className="mb-3 pt-2 me-2">
                                    <Form.Label className="form-label me-4 pe-4">Publish On Portal</Form.Label>
                                    <Form.Check type="checkbox" id="checkboxId" inline  />
                                </div>
                            </Col>
                            <Col lg={6} md={6} sm={6} xs={12}>
                            <div className="mb-3 pt-2 me-2">
                                    <Form.Label className="form-label">Document Name<span className="important">*</span> </Form.Label>
                                    <Form.Control type="text" className="form-control" required />
                                </div>
                                <div className="mb-3 pt-2 me-2">
                                    <Form.Label className="form-label">Document<span className="important">*</span> </Form.Label>
