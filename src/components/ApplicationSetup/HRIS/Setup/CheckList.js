                    ...
                    <Form className="form SetupForm mt-4 ms-2">
                        <Row className="textfield">
                            ...
                            <Col lg={6} md={6} sm={6} xs={12}>
                                ...
                                <div className="mb-3 pt-2 me-2">
                                    <Form.Label className="form-label">Sequence<span className="important">*</span> </Form.Label>
                                    <Form.Control type="text" className="form-control" required />
                                </div>
                            </Col>
                            <Col lg={6} md={6} sm={6} xs={12}>
                            ...
                            <Row className='mb-4'>
                                <Form.Label className="form-label">Processes</Form.Label>
                                <Col lg={6} md={6} sm={6} xs={12}>
                                    <div className=" me-3">
                                        <Form.Check type="checkbox" id="checkboxId" inline />
                                        <Form.Label className="form-label ms-3 ps-3">Employee Exit</Form.Label>
                                    </div>
                                </Col>
                                <Col lg={6} md={6} sm={6} xs={12}>
                                    <div>
                                        <Form.Check type="checkbox" id="checkboxId" inline />
                                        <Form.Label className="form-label ms-3 ps-3">Employee Hiring</Form.Label>
                                    </div>
                                </Col>
                            </Row>
