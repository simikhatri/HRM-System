                        ...
                        <Row className="textfield">
                            ...
                            <Col lg={6} md={6} sm={6} xs={12}>
                                ...
                                <div className="mb-3 pt-2 me-2">
                                    <Form.Label className="form-label">Category<span className="important">*</span> </Form.Label>
                            ...
                            <Col lg={6} md={6} sm={6} xs={12}>
                                <div className="mb-4 me-2 pt-2">
                                    <Form.Label className="form-label">Job Order No<span className="important">*</span> </Form.Label>
                                    <Form.Control type="text" className="form-control" required />
                                </div>
                                <div className="mb-3 pt-2 me-2">
                            ...
                            <div className="mb-4 pt-2">
                                    <Form.Label className="form-label">Client<span className="important">*</span> </Form.Label>
                                   <Row>
                                    <Col lg={6} md={6} sm={6} xs={12}>
                                        <div className="mb-4 pt-2 ">
                                        <Form.Check inline label="Pre-Sales Client" type="radio" id="Pre-Sales" name="radioGroup" />
                                            <Form.Select className="form-select status" name="cat" aria-label="Default select example" required>
                                                <option selected>--Please Select--</option>
                                                <option value="1">One</option>
                                                <option value="2">Two</option>
                                    ...
                                    <Col lg={6} md={6} sm={6} xs={12}>
                                        <div className="mb-4 pt-2 ">
                                        <Form.Check inline label="Oracle Clientt" type="radio" id="Oracle" name="radioGroup" />
                                            <Form.Select className="form-select status" name="cat" aria-label="Default select example" required>
                                                <option selected>--Please Select--</option>
                                                <option value="1">One</option>
                                                <option value="2">Two</option>
