                    ...
                    <Form className="form SetupForm mt-4 ms-2">
                        <Row className="textfield">
                            ...
                            <Col lg={3} md={6} sm={6} xs={12}>
                                ...
                                <div className="mb-4 pt-2">
                                    <Form.Label className="form-label"><span className="important"></span>
                                    </Form.Label>
                                    <Link className="InfoLink" to="">View Complete Information</Link>
                                </div>
                            </Col>
                            ...
                            <div className="d-flex flex-row-reverse MidReview">
                                <button type="button" onClick={handleClick} className="btn">Cancel</button>
                                <button type="button" className="btn mr-2">Initiate Process</button>
                            </div>
                        </Row>
                    </Form>
                </div>
