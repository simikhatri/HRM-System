                ...
                <div className="MainContent">
                    <Form className="form SetupForm mt-4 ms-2">
                        <Row className="textfield">
                            <div className="Heading pb-2 ps-1">
                                <Row>
                                    <Col lg={10} md={10} sm={10} xs={10}>
                                        <h5>Employee Delegation - Add New</h5>
                                    </Col>
                            ...
                            <Col lg={6} md={6} sm={6} xs={12}>
                            <div className="mb-4 me-2 pt-2">
                                    <Form.Label className="form-label">Start Time<span className="important">*</span> </Form.Label>
                                    <Form.Control type="time" className="form-control" required />
                                </div>
                                <div className="mb-4 me-2">
                                    <Form.Label className="form-label">End Time<span className="important">*</span> </Form.Label>
                                    <Form.Control type="time" className="form-control" required />
                                </div>
                                <div className="mb-3 me-2">
                                    <Form.Label className="form-label">Delegation Employee<span className="important">*</span> </Form.Label>
                                    <Form.Select className="form-select status" name="cat" aria-label="Default select example" required>
                                        <option selected>--Please Select--</option>
                                        <option value="1">One</option>
                                        <option value="2">Two</option>
