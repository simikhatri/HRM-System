                        ...
                        <Row className="textfield">
                            <div className="Heading pb-2 ps-1">
                                <Row>
                                    <Col lg={10} md={10} sm={10} xs={10}>
                                        <h5>Employee Acting Designation - Add New</h5>
                                    </Col>
                            ...
                            <Col lg={6} md={6} sm={6} xs={12}>
                                <div className="mb-3 pt-2 me-2">
                                    <Form.Label className="form-label">Select Employee<span className="important">*</span> </Form.Label>
                            ...
                            <Col lg={6} md={6} sm={6} xs={12}>
                            <div className="mb-4 me-2 pt-4 mt-4">
                                    <Form.Label className="form-label">Assign It</Form.Label>
                                </div>
                            </Col>
