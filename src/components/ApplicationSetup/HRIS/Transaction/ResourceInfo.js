                        ...
                        <Row className="textfield">
                            ...
                            <div className="mb-4 me-2 pt-2">
                                ...
                                <div className="mb-3 pt-2 me-2">
                                    <Form.Label className="form-label">Resource Type<span className="important">*</span> </Form.Label>
                            ...
                            <div className="mb-4 me-2 pt-2">
                                ...
                                <div className="mb-4 me-2 Consultant">
                                    <Form.Label className="form-label me-3">Include Consultant<span className="important">*</span> </Form.Label>
                                    <Form.Check type="checkbox" id="checkboxId" inline  />
                                </div>
                            </Col>
                            <div className="d-flex flex-row-reverse">
                                <button type="button" onClick={handleClick} className="btn">Export</button>
